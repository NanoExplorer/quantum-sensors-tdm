...
class dfbcard(QWidget):
    ...
    def __init__(self,
        ...
        self.dfbx2_widget1 = dfbrap.dfbrap(parent=self,
                                           addr=addr,
                                           slot=slot,
                                           column=1,
                                           seqln=seqln,
        ...
        self.dfbx2_widget2 = dfbrap.dfbrap(parent=self,
                                           addr=addr,
                                           slot=slot,
                                           column=2,
                                           seqln=seqln,
        ...
        self.card_glb_widget.setFixedWidth(
            int(self.dfbx2_widget1.width() / 2 + 10))
    ...
    def LED_changed(self):
        log.debug(tc.FCTCALL + "send LED boolean (True = OFF) to DFBx2 card:" +
                  tc.ENDC)
...
#        if self.unlocked == 1:
    ...
    def send_triangle(self, wreg4):
        log.debug(
            tc.FCTCALL + "send triangle parameters to DFB CH1 on DFBx2 card:",
            tc.ENDC)
        ...
        log.debug(
            tc.FCTCALL + "send triangle parameters to DFB CH2 on DFBx2 card:",
            tc.ENDC)
...
# child called methods
    ...
    def send_global_regs(self):
        ...
        log.debug("DFB:WREG6: global parameters: PS, DFBx2_XPT, NSAMP:", PS,
                  XPT, NSAMP)
        ...
        log.debug(
            "DFB:WREG7: global parameters: LED, ST, Prop Delay, Card Delay, sequence length, SETT:",
