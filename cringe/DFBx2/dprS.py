        ...
        if len(filename) > 0:
            ...
            for idx, val in enumerate(f):
                ...
                self.phase_counters[idx].loadCal(
                    int(val)
                )  #   13apr16:    chg to call loadCal with passthru coefficient consistent with dprcal mar16 cleanup
...
#           self.phase_counters[i].loadCal()
    ...
    def CalAllCounters(self):
        ...
        log.debug(tc.INIT + "auto calibrate: ", self.card_type, "card address",
